...
Overview
Alice is an anime inspired LLM project. She listens and remembers your conversations. It combines Ollama's LLM model and FishAudio. In the process of developing and designing an animatronic body for Alice that would serve as a physical companion and therapist for
individuals who are unable to meet with therapists and counselors on a regular basis while also serving as an educational tool for learning multiple languages such as Japanese.
...
- Research and assistant tools such as a to-do list and self-improving code
